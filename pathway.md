...
**注意**: 体检有效期12个月（从2026-08算到2027-08，覆盖整个PR审批期）
**无犯罪证明**: 已在步骤3a提前办理完毕
...
```
2026-04  ████ IELTS备考 + 法语学习 + 无犯罪证明申请 + 创建EE档案
2026-05  ████ 继续备考 + 等待无犯罪证明
2026-06  ██── IELTS考试 + 无犯罪证明完成
2026-07  ██── TEF考试 + CELPIP(条件) → 更新EE档案 → 申请Ontario/Alberta PNP
2026-08  ████ 体检（并行）+ 等待PNP
2026-09  ──── 等待PNP审批
2026-10  ██── 获得省提名 → 收到ITA
2026-11  ████ 提交PR申请 + 生物采集
